 ...
 * The API allows you to specify a move location (which essentially jumps from the previous point
 * to the new one), a line location (which creates a line segment from the previous location)
 * & a curve location (which creates a Bozier curve from the previous location).
 */
