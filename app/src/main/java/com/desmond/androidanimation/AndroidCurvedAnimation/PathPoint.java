...
/**
 * A class that holds information about a location & how the path should get to that location
 * from the previous path location (if any). Any PathPoint holds the information for its
 * location as well as the instructions on how to traverse the preceding interval from the
 * previous location
 */
public class PathPoint {

    /**
     * The possible path operations that describes how to move from a preceding PathPoint to
     * the location described by this PathPoint
     */
    ...
    /**
     * The motion described by the path to get from the previous PathPoint in an
     * AnimatorPath to the location of this PathPoint. This can be one of MOVE, LINE, or CURVE
     */
    int mOperation;
